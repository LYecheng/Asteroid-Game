...
public class CommandCenter {
    ...
    private static boolean bShield = false;
	...
	public static CopyOnWriteArrayList<Movable> movFloatersLife = new CopyOnWriteArrayList<Movable>();
    public static CopyOnWriteArrayList<Movable> movFloatersShield = new CopyOnWriteArrayList<Movable>();
    public static CopyOnWriteArrayList<Movable> movFloatersCruise = new CopyOnWriteArrayList<Movable>();
	...
	public static void clearAll(){
		...
		movFriends.clear();
		movFoes.clear();
        movFloatersLife.clear();
        movFloatersShield.clear();
	}
    ...
    public static boolean isShield() {return bShield;}

    public static void setShield(Boolean s) {bShield = s;}
    ...
    public static int getNumShields() {return nNumShield;}

    public static void setNumShields(int sParam) {nNumShield = sParam;}

    public static int getNumCruise() {return nNumCruise;}

    public static void setNumCruise(int sCru) {nNumCruise = sCru;}
    ...
    public static CopyOnWriteArrayList<Movable> getMovFloatersShield() {return movFloatersShield; }
